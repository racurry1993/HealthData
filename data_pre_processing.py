def preprocessing_garmin_data(username, password, start_date, end_date):
    ...
    GARMIN_HEADERS = ['Date','distance','duration','elapsedDuration','movingDuration',
    'elevationGain','elevationLoss','averageSpeed','maxSpeed','calories','bmrCalories',
    'averageHR','maxHR','maxRunningCadenceInStepsPerMinute','steps','aerobicTrainingEffect','anaerobicTrainingEffect',
    'vO2MaxValue','maxDoubleCadence','locationName','lapCount','waterEstimated','trainingEffectLabel','activityTrainingLoad',
    'minActivityLapDuration','aerobicTrainingEffectMessage','anaerobicTrainingEffectMessage','moderateIntensityMinutes_x',
    'vigorousIntensityMinutes_x','hrTimeInZone_1','hrTimeInZone_2','hrTimeInZone_3','hrTimeInZone_4','hrTimeInZone_5',
    'totalSets','activeSets','totalReps','typeKey_clean','startHour','startTimeCat','awakeCount',
    'ageGroup','averageRespirationValue','avgSleepStress','sleepScoreInsight','sleepScoreFeedback',
    'charged','drained','totalKilocalories','activeKilocalories','bmrKilocalories','wellnessKilocalories',
    ...
    'activeSeconds','sedentarySeconds','sleepingSeconds','moderateIntensityMinutes_y','vigorousIntensityMinutes_y',
